  ...
  return (
    <main style={{ background: "#ffffff", overflowX: "hidden" }}>
      ...
      >
        ...
        <div style={{ width: 96, height: 96, margin: "0 auto 2.5rem", position: "relative", zIndex: 1 }}>
          <svg viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg" width="96" height="96">
            <circle cx="48" cy="48" r="46" stroke="var(--muted-foreground)" strokeWidth="0.5" strokeDasharray="3 5"/>
            <circle cx="48" cy="48" r="34" stroke="var(--muted-foreground)" strokeWidth="0.5"/>
            <circle cx="48" cy="48" r="22" stroke="var(--primary)" strokeWidth="0.5" opacity="0.4"/>
            <circle cx="48" cy="48" r="10" fill="rgba(160,120,40,0.08)" stroke="var(--primary)" strokeWidth="0.75" opacity="0.6"/>
            <circle cx="48" cy="48" r="4" fill="var(--primary)" opacity="0.5"/>
            <circle cx="48" cy="48" r="1.5" fill="#1a1a2e"/>
            <line x1="48" y1="2" x2="48" y2="12" stroke="var(--muted-foreground)" strokeWidth="0.75" opacity="0.5"/>
            <line x1="48" y1="84" x2="48" y2="94" stroke="var(--muted-foreground)" strokeWidth="0.75" opacity="0.5"/>
            <line x1="2" y1="48" x2="12" y2="48" stroke="var(--muted-foreground)" strokeWidth="0.75" opacity="0.5"/>
            <line x1="84" y1="48" x2="94" y2="48" stroke="var(--muted-foreground)" strokeWidth="0.75" opacity="0.5"/>
            <line x1="16" y1="16" x2="22" y2="22" stroke="var(--muted-foreground)" strokeWidth="0.5" opacity="0.35"/>
            <line x1="74" y1="16" x2="68" y2="22" stroke="var(--muted-foreground)" strokeWidth="0.5" opacity="0.35"/>
            <line x1="16" y1="80" x2="22" y2="74" stroke="var(--muted-foreground)" strokeWidth="0.5" opacity="0.35"/>
            <line x1="80" y1="80" x2="74" y2="74" stroke="var(--muted-foreground)" strokeWidth="0.5" opacity="0.35"/>
          </svg>
        </div>
        ...
        >
          <span style={{ display: "block", width: 56, height: 1, background: "linear-gradient(to left, var(--muted-foreground), transparent)", opacity: 0.6 }} />
          Another name for lightworkers
          <span style={{ display: "block", width: 56, height: 1, background: "linear-gradient(to right, var(--muted-foreground), transparent)", opacity: 0.6 }} />
        </div>
        ...
        <div style={{ maxWidth: 880, margin: "0 auto", padding: "0 2rem 3rem" }}>
          {nextEvent ? (
            ...
            >
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--muted-foreground)", marginBottom: "0.75rem" }}>
                {formatEventDate(nextEvent.starts_at!, nextEvent.timezone)}
                {nextEvent.location && ` · ${nextEvent.location}`}
              </p>
              {nextEvent.description && (
                <p style={{ fontFamily: "var(--font-body)", fontStyle: "italic", color: "var(--muted-foreground)", fontSize: "1rem", marginBottom: "1rem" }}>
                  {nextEvent.description}
                </p>
              )}
              <Link
            ...
            >
              ...
              {latestPost.body && (
                <p style={{ fontFamily: "var(--font-body)", fontStyle: "italic", color: "var(--muted-foreground)", marginBottom: "1rem" }}>
      ...
      >
        ...
        >
          <span style={{ display: "block", width: 40, height: 1, background: "var(--primary)", opacity: 0.35 }} />
          The call
          <span style={{ display: "block", width: 40, height: 1, background: "var(--primary)", opacity: 0.35 }} />
        </div>
        <p
        ...
        >
          ...
          <em style={{ fontStyle: "normal", color: "var(--foreground)", fontWeight: 500 }}>
            this is your home.
          </em>
          &rdquo;
        </p>
      ...
      {/* ── Footer ──────────────────────────────────────────────────────────── */}
      <div style={{ height: 1, background: "var(--border)", maxWidth: 880, margin: "0 auto" }} />
      <footer
        style={{
          maxWidth: 880,
          margin: "0 auto",
