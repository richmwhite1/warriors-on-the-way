      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        <div className="space-y-3">
          ...
          {community.is_parent && community.rules_md && (
            <details style={{ border: "1px solid rgba(255,255,255,0.1)" }}>
              <summary style={{ padding: "0.75rem 1rem", fontFamily: "var(--font-brand)", fontSize: 10, fontWeight: 600, letterSpacing: "0.16em", textTransform: "uppercase", color: "#c8c2b4", cursor: "pointer" }}>
                Community Standards ↓
              </summary>
              <div style={{ padding: "0.75rem 1rem 1rem", borderTop: "1px solid rgba(255,255,255,0.1)", background: "#2e2820" }}>
          ...
          {!community.is_parent && parentCommunity?.rules_md && (
            <details style={{ border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <div style={{ padding: "0.75rem 1rem 1rem", borderTop: "1px solid rgba(255,255,255,0.1)", background: "#2e2820" }}>
                <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.3)", marginBottom: "0.5rem" }}>Standards all Warriors on the Way communities follow:</p>
